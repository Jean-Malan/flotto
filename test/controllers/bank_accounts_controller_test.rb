...
class BankAccountsControllerTest < ActionController::TestCase
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post :create, bank_account: { code: @bank_account.code, name: @bank_account.name, opening_balance: @bank_account.opening_balance }
    end
  ...
  test "should update bank_account" do
    patch :update, id: @bank_account, bank_account: { code: @bank_account.code, name: @bank_account.name, opening_balance: @bank_account.opening_balance }
    assert_redirected_to bank_account_path(assigns(:bank_account))
  end
