class JournalEntriesController < ApplicationController
  ...
  def new
    @journal_entry = JournalEntry.new.where("user_id =?", current_user.id)
  ...
  private
    ...
    def journal_entry_params
      params.require(:journal_entry).permit(:description, :amount, :account_id, :debit, :credit, :date, :user_id, :journal_id, :gl_account_id, :current_liability, :non_current_liability, :equity)
    end
end
