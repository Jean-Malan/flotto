class JournalsController < ApplicationController
  ...
  def index
    ...
    @journals = Journal.where("user_id =?", current_user.id).all
  end
  end
  ...
  private
    ...
    def journal_params
      params.require(:journal).permit(:description, :date, :reference, :user_id, journal_entries_attributes: [:user_id, :id, :description, :amount, :account_id, :gl_account_id, :debit, :credit, :date, :user_id])
    end
end
